...
def mouse_event(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONUP:
        ...
        CLOUD_ROT.points = o3.utility.Vector3dVector(np_cloud)
...
if __name__ == "__main__":
    ...
    cloud_in_ds = o3.geometry.PointCloud.voxel_down_sample(pcd, 0.005)
    ...
    cloud_m_ds = o3.geometry.PointCloud.voxel_down_sample( cloud_m, voxel_size )
